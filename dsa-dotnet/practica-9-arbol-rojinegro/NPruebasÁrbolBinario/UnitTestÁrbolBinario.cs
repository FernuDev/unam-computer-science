...
public class PruebasÁrbolBinarioOrdenado : PruebasColección
{
    ...
    [Test]
	public void PruebaRemueve1()
    {
        IniciaPrueba("Remove", "Remover [50]-[50]", 1.0);
		IÁrbolBinarioOrdenado<int> árbol = (IÁrbolBinarioOrdenado<int>)CreateCollection<int>();
		árbol.Add(50);
		Assert.That(árbol.Remove(50), Is.True);
        Assert.That(árbol.Count, Is.EqualTo(0));
		SumaPuntos(1.0);
	}
