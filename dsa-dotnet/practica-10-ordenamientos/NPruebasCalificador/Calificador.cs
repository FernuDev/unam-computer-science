...
public abstract class Calificador
{
    ...
    protected static List<string> cadenasAleatorias = null!;

    /// <summary>
    /// Estructura con datos generados aleatoriamente para hacer pruebas.
    /// </summary>
    protected static List<string?> cadenasAleatoriasConNulls = null!;
    ...
    /*public static bool ContieneRubro(Rubro rubro)
    {
        return _rubros.ContainsKey(rubro.Nombre);
    }*/

    /// <summary>
    /// Sólo puede ser llamado después de <codeAsignaRubros</code>
    /// </summary>
    /// <param name="rubro"></param>
    protected static void AgregaRubro(Rubro rubro)
    {
        _rubros.Add(rubro.Nombre, rubro);
    }
