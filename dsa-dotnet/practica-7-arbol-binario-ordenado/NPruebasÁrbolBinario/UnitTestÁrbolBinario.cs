...
public class Tests : PruebasColección
{
    ...
    protected IÁrbolBinarioOrdenado<C> CreateComparableCollection<C>() where C : IComparable<C>
    {
        return new ÁrbolBinarioOrdenado<C>();
    }
        
    protected IÁrbolBinarioOrdenado<int> CreateFilledComparableCollection()
    {
        //             25
        //       15          45
        //    10                 63
        //  0   13             51
        IÁrbolBinarioOrdenado<int> árbol = new ÁrbolBinarioOrdenado<int>();
