...
namespace ED.Estructuras.NoLineales.ÁrbolBinario
{
    ...
    {   
        ...
        /// </summary>
        public INodoBinarioOrdenado <C>? Padre { get; set; }
        INodoBinarioOrdenado <C>? INodoBinarioOrdenado<C>.Padre
        {
            get => Padre;
            set => Padre = (NodoBinarioOrdenado<C>)value!;
        } 
        ...
        /// </summary>
        public INodoBinarioOrdenado <C>? HijoI { get; set; }
        INodoBinarioOrdenado <C>? INodoBinarioOrdenado<C>.HijoI
        {
            get => HijoI;
            set => HijoI = (NodoBinarioOrdenado<C>)value!;
        } 
        ...
        /// </summary>
        public INodoBinarioOrdenado<C>? HijoD { get; set; }
        INodoBinarioOrdenado <C>? INodoBinarioOrdenado<C>.HijoD
        {
            get => HijoD;
            set => HijoD = (NodoBinarioOrdenado<C>)value!;
        }
        ...
        public NodoBinarioOrdenado (C dato, NodoBinarioOrdenado<C> padre) 
        {
            Dato = dato;
            Padre = padre;
            HijoD = null;
        ...
        public bool EsHoja()
        {
            if(HijoD == null && HijoI == null) return false;
            return true;
        }
        ...
        private void AgregarNodo(INodoBinarioOrdenado<C> nodoActual, C item)
        {
            ...
            if (item.CompareTo(nodoActual.Dato) < 0) // menor
            {
                ...
                if (nodoActual.HijoI == null)
                {
                    ...
                    nodoActual.HijoI.Padre = (NodoBinarioOrdenado<C>)nodoActual;
                }
                else
                {
