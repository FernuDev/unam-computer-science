!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ! Formula de Kubo-Greenwood para la conductividada electrica a
      ! T = 0K del hexano. Usaremos unidades atomicas: e=hbar=m=a=1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      PROGRAM KUBO
      IMPLICIT NONE
...
!
!
      OPEN(15,FILE='conductividad.dat')!Archivo de salida
!
      Efmin=-2.0d0 !Energia de Fermi minima
      Efmax=2.0d0  !Energia de Fermi maxima 
      nEf=20      !Numero de diviciones 
      NPI=4.0d0*ATAN(1.0d0) !Numero pi
!      
      Omega=N! Volumen del sistema, cada atomo aporta una unidad de volumen
      ETA=1.0q-4/N! Parte imaginaria de la energia Z=E+i*eta
!
!16    FORMAT(6E15.7,I15)
!!!!!!!!!!!!!!!!!!!!! TRAZAE vs E0 o MU  !!!!!!!!!!!!!!!
      DO i=0,nEF+1
       EF=EFmin+i*(EFmax-EFmin)/nEF! Enefia de Fermi
